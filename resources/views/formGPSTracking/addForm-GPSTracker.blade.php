                ...
                <form action="{{ route('tracking.store') }}" method="POST">
                    ...
                    <div class="mb-6 flex space-x-4">
                        ...
                        <div class="w-1/5">
                            ...
                            <input type="number" step="any" name="speed" id="speed" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:border-orange-500 focus:ring-orange-500" required value="{{ old('speed') }}">
                            @error('speed')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
