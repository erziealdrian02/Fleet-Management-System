<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Manajemen Kendaraan -->
            <x-dropdown-sidebar title="Manajemen Kendaraan" :defaultOpen="false">
            ...
            <x-dropdown-sidebar title="Manajemen Perjalanan"  :defaultOpen="false">>
                <x-link-sidebar>
            ...
            <!-- Keamanan & Insiden -->
            <x-dropdown-sidebar title="Keamanan & Insiden"  :defaultOpen="false">>
                <x-link-sidebar>
